  ...
  return (
    ...
    >
      ...
      <div className="kontak mt-16 sm:p-10 p-0" id="kontak">
        ...
        <form
          action="https://formsubmit.co/spaceworkbgs@gmail.com"
          method="POST"
          className={`${theme.card} ${theme.border} border p-10 sm:w-fit w-full mx-auto rounded-md`}
          autoComplete="off"
        >
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="pesan" className={`font-semibold ${theme.text}`}>
                Pesan
              </label>
              <textarea
                name="pesan"
